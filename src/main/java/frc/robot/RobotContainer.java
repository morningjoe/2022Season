...
import frc.robot.commands.DriveTankCmd;
...
public class RobotContainer {
  ...
  DriveTankSubsystem driveSub = new DriveTankSubsystem();
  ...
  public RobotContainer() {
    ...
    // make drive command
    Command driveCmd = new DriveTankCmd(driveSub,
